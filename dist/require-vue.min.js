...
"use strict";function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}var _createClass=function(){function e(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(t,n,r){return n&&e(t.prototype,n),r&&e(t,r),t}}();require("promise/polyfill");var buble=require("./buble"),less=require("less/lib/less-browser/bootstrap"),GUID_HELPER=0,VM_HEADER="\nvar exports = {};\nvar module  = {};\nObject.defineProperty( module, 'exports', {\n\tget: function()  { return exports; },\n\tset: function(v) { exports = v; return exports; },\n});\n(function() {\n",VM_FOOTER="\n}());\nreturn exports;\n";module.exports=function(){function e(t){_classCallCheck(this,e),this._guid="v__guid__helper--"+GUID_HELPER++,this._componentElement=t}return _createClass(e,[{key:"compileScript",value:function(e,t){var n=this._componentElement.querySelector("script");if(n){var r=buble.transform(n.innerHTML),o=[];r.code.replace(/require\(\s*([\"'])((?:\\\1|.)*?)\1\s*\)/g,function(e,t,n){o.push(n)});return t.require(o).then(function(n){var o=new Function("global","require",VM_HEADER+r.code+VM_FOOTER),i=o(t.global||window,n);for(var l in i)e.component[l]=i[l]})}}},{key:"compileTemplate",value:function(e){var t=this._componentElement.querySelector("template"),n=t.getAttribute("tag")||"div",r=t.getAttribute("class")||"";e.component.template="<"+n+" class="+JSON.stringify(r+" "+this._guid)+">"+t.innerHTML+"</"+n+">"}},{key:"compileStyle",value:function(e){var t=this._componentElement.querySelector("style");if(t){var n="."+this._guid+" { "+t.textContent+" }";return new Promise(function(e,t){less.render(n,function(n,r){return n?void t(n):void e(r)})}).then(function(e){var t=e.css;if(t){var n=document.head||document.body,r=document.createElement("style"),o=document.createTextNode(t);r.appendChild(o),n.appendChild(r)}})}}},{key:"compile",value:function(e){var t=this,n={component:{}};return Promise.resolve().then(function(){return Promise.all([t.compileScript(n,e),t.compileTemplate(n,e),t.compileStyle(n,e)])}).then(function(){return n.component})}}]),e}();
...
"use strict";require("promise/polyfill"),function(e,n){"function"==typeof define&&define.amd?define(["vue"],n):e.VueRequire=n(e.Vue)}(window,function(e){function n(e){var n=o.parseFromString("<!doctype html><html><head></head><body>"+e+"</body></html>","text/html");return n.body}var r=require("./request"),t=require("./requireHelper"),u=require("./Compiler"),o=new DOMParser,i={registerAllComponentsTags:function(n){var r=this;n=n||{};for(var u=document.getElementsByTagName("link"),o=n.global||window,a=n.require||t.buildDependencyRequire({require:function(e){function n(n,r,t){return e.apply(this,arguments)}return n.toString=function(){return e.toString()},n}(function(e,r,t){var u=e[0];if("v!"===u.substr(0,2)){var m=u.substr(2),f=i.pathToName(m);return void r(function(e,n){return i.loadComponent(m+".vue",{name:f,require:a})})}r(n.map&&n.map[u]?o[n.map[u]]:o[u])})}),m=function(n,t){var o=u[n];if("template/vue"===o.rel||"text/vue"===o.type){var m=o.getAttribute("name")||r.pathToName(o.href);e.component(m,function(e,n){i.loadComponent(o.href,{name:m,require:a}).then(e,n)})}},f=0,l=u.length;f<l;++f)m(f,l);return Promise.resolve()},loadComponent:function(e,t){return r(e).then(function(e){var r=n(e),o=new u(r);return o.compile(t).then(function(e){return e})})},pathToName:function(e){return e},load:function(e,n,r,u){var o=t.buildDependencyRequire({require:n});r(function(){return i.loadComponent(e+".vue",{name:e,config:u,require:o})})}};return i});
