...
"use strict";require("promise/polyfill"),define(["vue"],function(r){function e(r){var e=o.parseFromString("<!doctype html><html><head></head><body>"+r+"</body></html>","text/html");return e.body}var n=require("./request"),t=require("./Compiler"),o=new DOMParser;return{load:function(o,i,u,c){n(o+".vue",function(n,a){if(n)return u.error(n);try{var f=e(a),l=new t(f);l.compile({name:o,require:i,config:c}).then(function(e){r.component(o,e),u(e)},function(r){u.error(r)})}catch(r){u.error(r)}})}}});
},{"./Compiler":107,"./request":110,"promise/polyfill":106}],110:[function(require,module,exports){
"use strict";function request(e,t){var n=new XMLHttpRequest;n.onreadystatechange=function(){n.readyState>=4&&(200==n.status?t(null,n.responseText):t(new Error))},n.open("GET",e),n.send()}module.exports=request;
},{}]},{},[109]);
